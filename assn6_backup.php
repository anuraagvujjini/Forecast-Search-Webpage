<html>
    ...
    #forecast #1 #2
        ...
        function validateloc()
            {
            if(document.getElementById('straddr').value == '')
...
<body >
	...
	<option value="WY" <?php if(isset($_POST["State"]) AND $_POST["State"] == "WY") { echo "selected='selected'"; } ?>>Wyoming</option>
      ...
      <tr align="center">  <td><label for="Degree">Degree:* </label></td>
   <td> Fahrenheit <input type="radio" name="Degree" value="Fahrenheit" checked <?php if(isset($_POST["Degree"]) AND $_POST["Degree"] == "Fahrenheit") { echo "checked";} ?>/>
       Celsius <input type="radio" name="Degree" value="Celsius" <?php if(isset($_POST["Degree"]) AND $_POST["Degree"] == "Celsius") { echo "checked";} ?> /> </td></tr>
        <tr align="center"><td></td>     
 <td><input type="submit" id= "Search" name="Search" value="Search" onclick="return validateloc(); " />
            <input type="reset" name="Clear" value="Clear" onclick="return clearform();"/></td></tr>
    ...
    {
    $link = "https://maps.google.com/maps/api/geocode/xml?address=".rawurlencode($_POST["straddr"] . "," . $_POST["city"] . ",".$_POST["State"]."&key=AIzaSyBx4-5wbLpJ2RmEusD8Ro2s19SHOnHdZ_s");
  ...
  ?>
   ...
   echo "<td>".(int)$fcdata->currently->dewPoint."</td></tr>" ;
